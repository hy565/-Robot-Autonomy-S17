...
class AStarPlanner(object):
	...
	expanded = []
        ...
        start_node = self.planning_env.discrete_env.ConfigurationToNodeId(start_config[0])
        goal_node = self.planning_env.discrete_env.ConfigurationToNodeId(goal_config[0])
        ...
        idx = self.planning_env.discrete_env.NodeIdToConfiguration(node)[2]
        if self.visualize:
